...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _slideUp = __webpack_require__(328);

	var _slideUp2 = _interopRequireDefault(_slideUp);

	var _once2 = __webpack_require__(329);

	var _once3 = _interopRequireDefault(_once2);

	var _svg = __webpack_require__(330);
	...
	barba.init({
	  ...
	  transitions: [{
	    ...
	    leave: function leave(_ref) {
	      ...
	      return Promise.all([(0, _slideUp2.default)(current.container, duration, 0, -100), (0, _svg2.default)(current.container, duration)]);
	    },
	    ...
	    leave: function leave(_ref3) {
	      ...
	      return (0, _slideUp2.default)(current.container, duration * 0.5, 0, 100);
	    },
	    enter: function enter(_ref4) {
	      var next = _ref4.next;
	      return (0, _slideUp2.default)(next.container, duration * 0.5, -100, 0);
	    }
	  }, {
	    to: { namespace: 'home' },
	    once: function once(_ref5) {
	      var next = _ref5.next;
	      return (0, _once3.default)(next.container);
	    }
	  }]
		});
...
/***/ (function(module, exports) {
	...
	exports.default = function (targets, duration, from, to) {
...
/***/ (function(module, exports) {
	...
	exports.default = function (el) {
	  var targets = el.querySelectorAll('h1, h2, a');
	  var duration = 750;
	  var anim = anime({
	    autoplay: false,
	    targets: targets,
...
/***/ (function(module, exports) {
	...
	exports.default = function (container, duration) {
	  var shape = container.querySelector('.shape');
	  ...
	  return Promise.all([animShape.finished, animPath.finished]);
		};
